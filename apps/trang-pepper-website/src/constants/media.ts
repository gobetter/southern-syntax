// import { SORT_ORDERS, type SortOrder } from './common';
import { SORT_ORDERS } from './common';

export const MEDIA_SORTABLE_FIELDS = ['createdAt', 'filename', 'fileSize'] as const;
export type MediaSortableField = (typeof MEDIA_SORTABLE_FIELDS)[number];

export { SORT_ORDERS };

export const MEDIA_SORT_OPTIONS: { value: MediaSortableField; i18nKey: string }[] = [

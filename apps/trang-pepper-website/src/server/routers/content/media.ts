...
import { mediaUpdateFormInputSchema } from '@/schemas/media';
...
export const mediaRouter = router({
  ...
  getAll: authorizedProcedure(PERMISSION_RESOURCES.MEDIA, PERMISSION_ACTIONS.READ)
    .input(
      z.object({
  ...
  // ลบ media หลายรายการ
  deleteMany: authorizedProcedure(PERMISSION_RESOURCES.MEDIA, PERMISSION_ACTIONS.DELETE)
    .input(
      z.object({
  ...
  updateCategories: authorizedProcedure(PERMISSION_RESOURCES.MEDIA, PERMISSION_ACTIONS.UPDATE)
    .input(
      z.object({
  ...
  setCategories: authorizedProcedure(PERMISSION_RESOURCES.MEDIA, PERMISSION_ACTIONS.UPDATE)
    .input(
      z.object({
        mediaIds: z.array(z.string()).min(1),
  ...
  updateTags: authorizedProcedure(PERMISSION_RESOURCES.MEDIA, PERMISSION_ACTIONS.UPDATE)
    .input(
      z.object({
        mediaIds: z.array(z.string()).min(1),
        addIds: z.array(z.string()).optional(),
  ...
  setTags: authorizedProcedure(PERMISSION_RESOURCES.MEDIA, PERMISSION_ACTIONS.UPDATE)
    .input(
      z.object({
        mediaIds: z.array(z.string()).min(1),

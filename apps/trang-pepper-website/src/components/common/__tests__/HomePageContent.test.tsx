...
describe('<HomePageContent />', () => {
  it('renders translated text using provided t function', () => {
    ...
    expect(screen.getByText(/You are visiting the website in language/i)).toBeInTheDocument();
    expect(screen.getByText('English')).toBeInTheDocument();

    expect(t).toHaveBeenCalledWith('general.welcome');
    expect(t).toHaveBeenCalledWith('language.you_are_visiting_the_website_in_language');

...
// Constants สำหรับ Resources ที่เป็นไปได้สำหรับ Permissions
// export const PERMISSION_RESOURCES = {
//   USER: 'USER', // ผู้ใช้
//   ROLE: 'ROLE', // บทบาท
//   PERMISSION: 'PERMISSION', // สิทธิ์
//   PRODUCT: 'PRODUCT', // สินค้า
//   CATEGORY: 'CATEGORY', // หมวดหมู่สินค้า/บทความ
//   POST: 'POST', // บทความ/บล็อก
//   MEDIA: 'MEDIA', // สื่อ/รูปภาพ
//   LANGUAGE: 'LANGUAGE', // ภาษา
//   SETTINGS: 'SETTINGS', // การตั้งค่าระบบ
//   ADMIN_DASHBOARD: 'ADMIN_DASHBOARD', // Resource สำหรับ Admin Dashboard
// } as const; // <-- ทำให้เป็น readonly object

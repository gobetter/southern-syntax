...
export function parseVariantRecord(value: unknown): Record<string, string> | null {
...
export function getCommonIds<T extends { id: string }>(items: T[][]): Set<string> {
...
export function extractStoragePaths(variants: unknown, bucket: string): string[] {
